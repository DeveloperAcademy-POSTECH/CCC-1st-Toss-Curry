...
let assetRow1 = SectionList(image: "assetCorp", description: "보통예금(IBK나라사랑통장)", title: "50,000원", type: .account)
let assetRow2 = SectionList(image: "assetToss", description: "투자/토스증권", title: "100,000원", type: .account)
let assetRow3 = SectionList(image: "assetCorp", description: "IBK기업은행 예금", title: "200,000원", type: .account)
let assetRow4 = SectionList(image: "assetKB", description: "KB나라사랑우대통장", title: "300,000원", type: .account)
let assetRow5 = SectionList(image: "PointMoneyImage", description: "포인트・머니 ・ 3개", title: "50,000원", type: .etc)
...
let assetSectionData = TossData(sectionType: .assets, sectionList: [assetRow1, assetRow2, assetRow3, assetRow4, assetRow5])
